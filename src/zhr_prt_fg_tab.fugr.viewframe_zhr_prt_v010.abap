*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHR_PRT_V010
*   generation date: 03.11.2025 at 18:00:16
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHR_PRT_V010        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHR_PRT_V010'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHR_PRT_V010_EXTRACT
TOTAL = ZHR_PRT_V010_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHR_PRT_V010'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHR_PRT_V010-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHR_PRT_V010_EXTRACT
TOTAL = ZHR_PRT_V010_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHR_PRT_V010-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHR_PRT_V010'
...
TOTAL = ZHR_PRT_V010_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHR_PRT_V010-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHR_PRT_V010-UPD_FLAG NE SPACE.
