...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHR_PRT_VADMIN'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHR_PRT_VADMIN_EXTRACT
TOTAL = ZHR_PRT_VADMIN_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHR_PRT_VADMIN'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHR_PRT_VADMIN-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHR_PRT_VADMIN_EXTRACT
TOTAL = ZHR_PRT_VADMIN_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHR_PRT_VADMIN-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHR_PRT_VADMIN'
...
TOTAL = ZHR_PRT_VADMIN_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHR_PRT_VADMIN-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHR_PRT_VADMIN-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZHR_PRT_VADMIN'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZHR_PRT_VADMIN-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHR_PRT_VADMIN_EXTRACT
TOTAL = ZHR_PRT_VADMIN_TOTAL
