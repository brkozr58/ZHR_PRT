*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHR_PRT_V008
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHR_PRT_V008        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHR_PRT_V008'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHR_PRT_V008_EXTRACT
TOTAL = ZHR_PRT_V008_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHR_PRT_V008'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHR_PRT_V008-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHR_PRT_V008_EXTRACT
TOTAL = ZHR_PRT_V008_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHR_PRT_V008-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHR_PRT_V008'
...
TOTAL = ZHR_PRT_V008_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHR_PRT_V008-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHR_PRT_V008-UPD_FLAG NE SPACE.
