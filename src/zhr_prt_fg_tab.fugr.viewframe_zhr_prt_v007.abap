*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHR_PRT_V007
*   generation date: 05.11.2025 at 23:10:08
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHR_PRT_V007        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHR_PRT_V007'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHR_PRT_V007_EXTRACT
TOTAL = ZHR_PRT_V007_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHR_PRT_V007'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHR_PRT_V007-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHR_PRT_V007_EXTRACT
TOTAL = ZHR_PRT_V007_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHR_PRT_V007-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHR_PRT_V007'
...
TOTAL = ZHR_PRT_V007_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHR_PRT_V007-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHR_PRT_V007-UPD_FLAG NE SPACE.
