*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHR_PRT_VONYIK
*   generation date: 29.11.2025 at 00:44:53
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHR_PRT_VONYIK      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHR_PRT_VONYIK'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHR_PRT_VONYIK_EXTRACT
TOTAL = ZHR_PRT_VONYIK_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHR_PRT_VONYIK'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHR_PRT_VONYIK-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHR_PRT_VONYIK_EXTRACT
TOTAL = ZHR_PRT_VONYIK_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHR_PRT_VONYIK-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHR_PRT_VONYIK'
...
TOTAL = ZHR_PRT_VONYIK_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHR_PRT_VONYIK-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHR_PRT_VONYIK-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZHR_PRT_VONYIK'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZHR_PRT_VONYIK-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHR_PRT_VONYIK_EXTRACT
TOTAL = ZHR_PRT_VONYIK_TOTAL
